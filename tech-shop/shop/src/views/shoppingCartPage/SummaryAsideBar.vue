                ...
                <ProductOfferLine>
                    <template #offer>
                        <div class="offer-text">
                            ...
                            <a class="offer-text__link" href="#"> {{ $t('newProductSection.offerBlock.titleLink') }}</a>
                        </div>
                    </template></ProductOfferLine
                >
            </footer>
        </div>
    </aside>
...
const { getSubtotalValue } = storeToRefs(useCartStore())
const { addItemToOrderList, clearCartList } = useCartStore()
...
const showOrderTotalPrice = computed(() => dividedString(getSubtotalValue.value + priceForDelivery.value))

async function addToOrder() {
    dialog.value = true
    try {
        await addItemToOrderList()
        clearCartList()
    } catch (error) {
        console.log(error)
    } finally {
